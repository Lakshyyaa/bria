...
es_entity::entity_id! { ProfileId, PayoutQueueId, WalletId, SigningSessionId, PayoutId, AdminApiKeyId, AccountId, ProfileApiKeyId, BatchId, OutboxEventId, KeychainId }
// crate::entity_id! { SignerId } This was never used?
